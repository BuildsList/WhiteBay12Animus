...
/datum/game_mode
	...
	var/list/datum/uplink_item/uplink_items = list(
		"Ammunition" = list(
			...
			new/datum/uplink_item(/obj/item/ammo_magazine/chemdart, 1, "Darts", "AD"),
			new/datum/uplink_item(/obj/item/weapon/storage/box/sniperammo, 2, "14.5mm", "SA")
			),
		"Highly Visible and Dangerous Weapons" = list(
			 new/datum/uplink_item(/obj/item/weapon/storage/box/emps, 2, "5 EMP Grenades", "EM"),
			 new/datum/uplink_item(/obj/item/weapon/melee/energy/sword, 3, "Energy Sword", "ES"),
			 new/datum/uplink_item(/obj/item/weapon/gun/projectile/dartgun, 4, "Dart Gun", "DG"),
			 new/datum/uplink_item(/obj/item/weapon/gun/energy/crossbow, 4, "Energy Crossbow", "XB"),
			 new/datum/uplink_item(/obj/item/weapon/storage/box/syndie_kit/g9mm, 4, "Silenced 9mm", "S9"),
			 new/datum/uplink_item(/obj/item/mecha_parts/mecha_equipment/weapon/energy/riggedlaser, 6, "Exosuit Rigged Laser", "RL"),
			 new/datum/uplink_item(/obj/item/weapon/gun/projectile/revolver, 5, "Revolver", "RE"),
			 new/datum/uplink_item(/obj/item/weapon/storage/box/syndicate, 8, "Mercenary Bundle", "BU"),
			 new/datum/uplink_item(/obj/item/weapon/gun/projectile/heavysniper, 10, "Anti-materiel Rifle", "AMR")
			),
		"Stealthy and Inconspicuous Weapons" = list(
			...
			new/datum/uplink_item(/obj/item/weapon/pen/reagent/paralysis, 2, "Paralysis Pen", "PP"),
			new/datum/uplink_item(/obj/item/weapon/storage/box/syndie_kit/cigarette, 2, "Cigarette Kit", "BH"),
			new/datum/uplink_item(/obj/item/weapon/storage/box/syndie_kit/toxin, 2, "Random Toxin - Beaker", "RT")
			),
		"Stealth and Camouflage Items" = list(
			new/datum/uplink_item(/obj/item/weapon/card/id/syndicate, 1, "Agent ID card", "AC"),
			new/datum/uplink_item(/obj/item/clothing/shoes/syndigaloshes, 1, "No-Slip Shoes", "SH"),
			...
			new/datum/uplink_item(/obj/item/device/chameleon, 3, "Chameleon-Projector", "CP"),
			new/datum/uplink_item(/obj/item/clothing/mask/gas/voice, 4, "Voice Changer", "VC"),
			new/datum/uplink_item(/obj/item/weapon/disk/file/cameras/syndicate, 8, "Camera Network Access - Floppy", "SF")
			),
		"Devices and Tools" = list(
			...
			new/datum/uplink_item(/obj/item/device/encryptionkey/binary, 2, "Binary Translator Key", "BT"),
			...
			new/datum/uplink_item(/obj/item/device/powersink, 4, "Powersink (DANGER!)", "PS",),
			new/datum/uplink_item(/obj/item/device/radio/beacon/syndicate, 7, "Singularity Beacon (DANGER!)", "SB"),
			new/datum/uplink_item(/obj/item/weapon/circuitboard/teleporter, 15, "Teleporter Circuit Board", "TP")
			),
		"Implants" = list(
		...
		"Medical" = list(
			...
			new/datum/uplink_item(/obj/item/weapon/storage/firstaid/surgery, 4, "Surgery kit", "SK"),
			new/datum/uplink_item(/obj/item/weapon/storage/firstaid/combat, 4, "Combat medical kit", "CM")
		),
		"Hardsuit Modules" = list(
			new/datum/uplink_item(/obj/item/rig_module/vision/thermal, 2, "Thermal Scanner", "RTS"),
			new/datum/uplink_item(/obj/item/rig_module/fabricator/energy_net, 2, "Net Projector", "REN"),
			new/datum/uplink_item(/obj/item/weapon/storage/box/syndie_kit/ewar_voice, 3, "Electrowarfare Suite and Voice Synthesiser", "REV"),
			new/datum/uplink_item(/obj/item/rig_module/maneuvering_jets, 4, "Maneuvering Jets", "RMJ"),
			new/datum/uplink_item(/obj/item/rig_module/mounted/egun, 4, "Mounted Energy Gun", "REG"),
			new/datum/uplink_item(/obj/item/rig_module/power_sink, 5, "Power Sink", "RPS"),
			new/datum/uplink_item(/obj/item/rig_module/mounted, 6, "Mounted Laser Cannon", "RLC")
		),
